    ...
    def getHistory(self):
        ...
        for x in ans:
            ...
            if receiver[:5] == 'USER_':
                ...
                receiver = execute_sql(sql2, [receiver[5:]], False, True)[
                    0][0] + '('+execute_sql(sql2, [receiver[5:]], False, True)[0][1]+')'
...
class MobileRecharge:
    ...
    def make_recharge(self):
        ...
        list = [operator_id, self.sender_id,
                self.recharge_amount, self.receiver_mobile_no]
        execute_sql(sql, list, True, False)
